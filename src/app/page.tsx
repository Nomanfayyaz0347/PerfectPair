...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50/50 to-white flex flex-col">
      {/* Popup Modal */}
      {showPopup && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-5 animate-fadeIn">
          <div className="bg-white rounded-3xl shadow-2xl max-w-sm w-full overflow-hidden animate-slideUp">
            {/* Header */}
            <div className="bg-gradient-to-r from-teal-500 to-emerald-500 p-4 relative">
              <button
                onClick={() => setShowPopup(false)}
                className="absolute top-3 right-3 w-7 h-7 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center transition-all"
              >
              ...
              <div className="text-center">
                ...
                <h3 className="text-white font-bold text-base">Client Access</h3>
              </div>
            </div>
            ...
            <div className="p-5">
              <p className="text-gray-700 text-xs leading-relaxed text-center mb-4">
                Agar aap <span className="font-semibold text-teal-600">Client Access</span> lena chahte hain ya apne <span className="font-semibold text-teal-600">Matches</span> dekhna chahte hain, to humse contact karen!
              </p>

              {/* Contact Buttons */}
              <div className="space-y-2">
                <a
                  href="https://wa.me/923352762923?text=Hi,%20I%20want%20Client%20Access%20and%20want%20to%20see%20my%20matches"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white py-2.5 rounded-xl font-semibold text-xs transition-all active:scale-95 shadow-lg"
                >
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white py-2.5 rounded-xl font-semibold text-xs transition-all active:scale-95 shadow-lg"
                >
              ...
              <div className="mt-3 text-center">
                ...
                <p className="text-xs font-bold text-gray-800">+92 335 2762923</p>
              </div>
            </div>
          </div>
        </div>
